...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const DashboardPageWidget() : const LoginPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          path: '/manage-card',
          requireAuth: true,
          builder: (context, params) => ManageCardPageWidget(
        ...
        FFRoute(
          name: 'TermsOfUsePage',
          path: '/terms-of-use',
          builder: (context, params) => const TermsOfUsePageWidget(),
        ),
        FFRoute(
          name: 'ListCards',
          path: '/my-cards',
          requireAuth: true,
          builder: (context, params) => const ListCardsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/manage-account',
          builder: (context, params) => const ManageAccountPageWidget(),
        )
